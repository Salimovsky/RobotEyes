...
public class ColorPickerBaseActivity extends AppCompatActivity
    ...
    /**
     * A reference to the {@link ColorPickerBaseActivity.CameraAsyncTask} that gets the {@link Camera}.
     */
    ...
    /**
     * Switch view to select color pick mode: manual (user click on camera preview to select color), or automatic.
     */
    private SwitchCompat manualPickSwitch;
    private boolean isManualColorPickMode;
    ...
    /**
     * the intent {@link Intent#getAction action} that led to this activity.
     */
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        flashItem.setVisible(isFlashSupported());
    ...
    public void onClick(View v) {
        if (isManualColorPickMode) {
            applyPreviewColor(mSelectedColor);
        }
    }
    ...
    protected void initViews() {
        ...
        manualPickSwitch = findViewById(R.id.manual_pick);
        isManualColorPickMode = manualPickSwitch.isChecked();
        manualPickSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                isManualColorPickMode = isChecked;
            }
        });
