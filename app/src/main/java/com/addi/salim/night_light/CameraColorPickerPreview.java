...
/**
 * A simple {@link TextureView} used to render camera preview.
...
public class CameraColorPickerPreview extends TextureView implements TextureView.SurfaceTextureListener, Camera.PreviewCallback {
    ...
    /**
     * Set a {@link CameraColorPickerPreview.OnColorSelectedListener} that will be called each time a new color is selected.
     *
     * @param onColorSelectedListener the {@link CameraColorPickerPreview.OnColorSelectedListener} that will be called.
     */
