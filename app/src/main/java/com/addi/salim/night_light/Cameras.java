...
/**
 * Static utils methods for dealing with {@link Camera}.
 */
public final class Cameras {
    ...
    /**
     * Adapt the {@link Camera} display orientaiton to the current device orientation.
     *
     * @param context a {@link Context} to retrieve device orientation.
     * @param camera  the {@link Camera} to be adapted.
     */
